...
const MOT = [
  ...
  {min:51,max:75,i:'H',t:'Mais da metade! Seu corpo agradece!'},
  {min:76,max:99,i:'S',t:'Quase la! Voce e incrivel!'},
  {min:100,max:100,i:'K',t:'Dia PERFEITO! Parabens, voce arrasou!'}
  ];
...
async function toggle(el){
      ...
      applyDoneStates(); updateProgress();
     emoveProgress(S.user.id,S.viewDate,type,id);else await DB.addProgress(S.user.id,S.viewDate,type,id);}catch(e){console.error(e);}
}
